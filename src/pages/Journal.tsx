...
const JournalPage = () => {
  ...
  // Sample analysis data that would normally come from AI processing
  ...
  const handleSubmit = () => {
    // In a real app, send the journal entry to backend for analysis
      ...
      <div className="h-full">
        <div className="glass-panel p-6 mb-6">
          ...
          <p className="text-white/70">
            Record your thoughts, get insights and track your progress
          </p>
        </div>
          ...
          <div className="col-span-12 md:col-span-7">
            <div className="glass-panel p-6">
              ...
              <div className="flex border-b border-white/10 mb-6">
                <button 
                  className={`mr-4 pb-3 flex items-center ${activeTab === 'write' ? 'text-verve-teal border-b-2 border-verve-teal' : 'text-white/70'}`}
                  onClick={() => setActiveTab('write')}
                >
                  <Pencil size={16} className="mr-2" /> Write Entry
                </button>
                <button 
                  className={`pb-3 flex items-center ${activeTab === 'upload' ? 'text-verve-teal border-b-2 border-verve-teal' : 'text-white/70'}`}
                    ...
                    <ul className="space-y-2">
                      {journalAnalysis.extractedTasks.map((task, i) => (
                        <li key={i} className="flex items-start">
                          <div className="w-4 h-4 rounded-full border border-white/30 mt-0.5 mr-2 flex-shrink-0"></div>
